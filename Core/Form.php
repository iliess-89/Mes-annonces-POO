...
class Form
{
    ...
    /**
     * Valide si tous les champs son remplis 
     *
    ...
    {
        //on parcour les champs
        foreach ($champs as $champ) {

            if (!isset($form[$champ]) || empty($form[$champ])) {
                //on sort en returnant false
                return false;
            }
        }
        return true;
     ...
     *
     * @param array $attributs Tableau assosiatif ['class' => 'form-control']
     * @return string Chaine de caractére generée
     */
    private function ajoutAttributs(array $attributs): string
    {
        //On initialise un chaine de caractéres
        $str = '';

        //on liste les attribut "courts" 
